...
TEST_CASE("List::split", "[weight=1][part=2]") {
  ...
  PNG expected_1;
  expected_1.readFromFile("tests/ExpectedImages/expected-split_1.png");
  PNG expected_2;
  expected_2.readFromFile("tests/ExpectedImages/expected-split_2.png");
  PNG expected_3;
  expected_3.readFromFile("tests/ExpectedImages/expected-split_3.png");
  ...
  out1.writeToFile("tests/Results/actual-split_1.png");
  ...
  out2.writeToFile("tests/Results/actual-split_2.png");
  ...
  out3.writeToFile("tests/Results/actual-split_3.png");
...
TEST_CASE("List::merge", "[weight=1][part=2]") {
  ...
  PNG expected;
  expected.readFromFile("tests/ExpectedImages/expected-merge.png");
  ...
  out.writeToFile("tests/Results/actual-merge.png");
...
TEST_CASE("List::sort #1", "[weight=1][part=2]") {
  PNG expected;
  expected.readFromFile("tests/ExpectedImages/expected-sort_1.png");
  ...
  b3.writeToFile("tests/Results/actual-sort_1.png");
...
TEST_CASE("List::sort #2", "[weight=1][part=2]") {
  PNG expected;
  expected.readFromFile("tests/ExpectedImages/expected-sort_2.png");
  ...
  PNG b3 = b.genImg(v2, d);
  b3.writeToFile("tests/Results/actual-sort_2.png");
