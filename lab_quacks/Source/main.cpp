...
int main() {
  cout << boolalpha
       << endl; // make true and false print for booleans, not 0 and 1

  // Run sumDigits:
  cout << "==== sumDigits ====" << endl;
  cout << "sumDigits(243) = " << colorize(RecursionExercises::sumDigits(243), 9)
       << endl;
  cout << "expected       = " << 9 << endl;
  cout << "sumDigits(49)  = " << colorize(RecursionExercises::sumDigits(49), 13)
       << endl;
