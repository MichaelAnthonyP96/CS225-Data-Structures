...
int main(int argc, char *argv[]) {
  ...
  if (argc < 3 || argc > 5) {
    cout << argv[0]
         << " <image_size> <probability> [foreground color] [background color]"
         << endl;
  ...
  if (img_size >= 256) {
    cout << "Using large image size! out-structure.png will be generated but "
            "not viewable in the default editor!"
